                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <span class="account-user-avatar">
                                <img src="assets/images/users/avatar.jpg" alt="user-image" width="32" class="rounded-circle">
                            </span>
                            <span class="d-lg-flex flex-column gap-1 d-none">
                                <h5 class="my-0">M Naya Dzulqronain</h5>
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <div class="leftbar-user">
                    <a href="pages-profile.html">
                        <img src="assets/images/users/avatar.jpg" alt="user-image" height="42" class="rounded-circle shadow-sm">
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarDashboards">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="?pages=dash1">Dashboard 1</a>
                                </li>
                                <li>
                                    <a href="?pages=dash2">Dashboard 2</a>
                                </li>
                                <li>
                                    <a href="?pages=dash3">Dashboard 3</a>
                                </li>
                                <li>
                                    <a href="?pages=dash4">Dashboard 4</a>
                                </li>
                                <li>
                                    <a href="?pages=dash5">Dashboard 5</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarEmail">
                            <ul class="side-nav-second-level">
                                ...
                                <li>
                                    <a href="?pages=table">Data Table</a>
                                </li>
                                <li>
                                    <a href="?pages=blank">Blank Page</a>
                                </li>
                                <li>
                                    <a href="?pages=login">Login Form</a>
                                </li>
                                <li>
                                    <a href="?pages=register">Register Form</a>
                                </li>
                                <li>
                                    <a href="?pages=modal">Modal</a>
                                </li>
                            </ul>
                        </div>
                    </li>
