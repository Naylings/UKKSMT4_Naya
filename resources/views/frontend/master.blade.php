...
<!-- Mirrored from coderthemes.com/hyper/modern/landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 21 Apr 2024 07:52:05 GMT -->

<head>
    <meta charset="utf-8" />
    <title>Home | Aplikasi</title>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 offset-md-2">
                    <div class="text-md-end mt-3 mt-md-0">
                        <img src="{{ asset('assets/images/svg/startup.svg') }}" alt="" class="img-fluid" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row pb-3 pt-5 align-items-center">
                ...
                <div class="col-lg-5 col-md-6 offset-md-1">
                    <img src="{{ asset('assets/images/svg/features-2.svg') }}" class="img-fluid" alt="">
                </div>
            </div>
