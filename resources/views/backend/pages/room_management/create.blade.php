                        ...
                        <form method="POST" action="{{ route('room_management.room.store') }}">
                            ...
                            <div class="row">
                                <div class="mb-3 col-lg-3 col-md-4 col-sm-6">
                                    <label for="nis" class="form-label">Nomor Ruangan</label>
                                    <input type="text" id="nis" name="no" class="form-control">
                                </div>
                                <div class="mb-3 col-lg-3 col-md-4 col-sm-6">
                                    <label for="nisn" class="form-label">Nama Ruangan</label>
                                    <input type="text" id="nisn" name="name" class="form-control">
                                </div>
                            </div>
