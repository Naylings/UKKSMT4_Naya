            ...
            <div class="card">
                ...
                <div class="card-body pt-2">
                    <div class="d-flex align-items-start">
                        <img class="me-3 rounded-circle" src="{{ asset('assets/images/users/avatar-2.jpg') }}" width="40"
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-3 rounded-circle" src="{{ asset('assets/images/users/avatar-3.jpg') }}" width="40"
                            alt="Generic placeholder image">
                        <div class="w-100 overflow-hidden">
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-3 rounded-circle" src="{{ asset('assets/images/users/avatar-4.jpg') }}" width="40"
                            alt="Generic placeholder image">
                        <div class="w-100 overflow-hidden">
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-3 rounded-circle" src="{{ asset('assets/images/users/avatar-5.jpg') }}" width="40"
                            alt="Generic placeholder image">
                        <div class="w-100 overflow-hidden">
                            <span class="badge badge-warning-lighten float-end">Cold lead</span>
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-3 rounded-circle" src="{{ asset('assets/images/users/avatar-1.jpg') }}" width="40"
                            alt="Generic placeholder image">
                        <div class="w-100 overflow-hidden">
                            <span class="badge badge-warning-lighten float-end">Cold lead</span>
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-3 rounded-circle" src="{{ asset('assets/images/users/avatar-6.jpg') }}" width="40"
                            alt="Generic placeholder image">
                        <div class="w-100 overflow-hidden">
                            <span class="badge badge-success-lighten float-end">Won lead</span>
